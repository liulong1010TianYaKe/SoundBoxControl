...
- (void)viewDidLoad
{
    ...
    [self itemDidSelectedWithIndex:1];
}
...
- (void)viewInit
{
    ...
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE + 64, STATUS_BAR_HEIGHT, SCREEN_WIDTH, MAIN_TABBAR_HEIGHT) showArrowButton:_showArrowButton];
    [_navTabBar setBackgroundColor:APP_THEME_COLOR];//[UIColor clearColor]];
    _navTabBar.delegate = self;
//    _navTabBar.backgroundColor = [UIColor colorWithRed:243/255.0 green:243/255.0 blue:243/255.0 alpha:1.0];//_navTabBarColor;
    _navTabBar.lineColor = [UIColor clearColor];//_navTabBarLineColor;
    _navTabBar.itemTitles = _titles;
    _navTabBar.arrowImage = _navTabBarArrowImage;
    [_navTabBar updateData];
    
    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, _navTabBar.frame.origin.y + _navTabBar.frame.size.height, SCREEN_WIDTH, SCREEN_HEIGHT - _navTabBar.frame.origin.y - _navTabBar.frame.size.height - STATUS_BAR_HEIGHT - NAVIGATION_BAR_HEIGHT + STATUS_BAR_HEIGHT)];
