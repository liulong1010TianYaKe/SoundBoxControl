...
- (instancetype)initWithTitle:(NSString *)title
                      message:(NSMutableAttributedString *)message{
    self = [super init];
    if (self) {
...
-(void)buildViews{
    ...
    _labelTitle = [[UILabel alloc]initWithFrame:CGRectMake(31, 22, AlertWidth-2*AlertPadding, labelHeigh)];
    _labelTitle.font = [UIFont boldSystemFontOfSize:20];
    _labelTitle.textColor = APP_THEME_COLOR;// [UIColor blackColor];
    ...
    //message
    CGFloat messageHeigh = 160;//[self heightWithString:_message fontSize:14 width:AlertWidth-2*AlertPadding];

    _labelmessage =  [[UILabel alloc]initWithFrame:CGRectMake(31, _labelTitle.frame.origin.y+_labelTitle.frame.size.height, _alertView.bounds.size.width - 64, messageHeigh+2*AlertPadding)];
    _labelmessage.font = [UIFont systemFontOfSize:15];
    _labelmessage.textColor = [UIColor colorWithRed:117/255.0 green:117/255.0 blue:117/255.0 alpha:1.0];
    _labelmessage.textAlignment = NSTextAlignmentLeft;//NSTextAlignmentCenter;
    _labelmessage.attributedText = _message;//.text = _message;
...
//        button.layer.shadowOffset = CGSizeZero;
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, _alertView.bounds.size.width, 1)];
    lineView.backgroundColor = [UIColor colorWithRed:117/255.0 green:117/255.0 blue:117/255.0 alpha:0.6];
    [_buttonScrollView addSubview:lineView];
    UIView *lineView2 = [[UIView alloc] initWithFrame:CGRectMake(_alertView.bounds.size.width/2, 0, 1, MenuHeight)];
    lineView2.backgroundColor = [UIColor colorWithRed:117/255.0 green:117/255.0 blue:117/255.0 alpha:0.6];
    [_buttonScrollView addSubview:lineView2];
